          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Seamless Car Rentals for All Your Travel Needs
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience the reliability and convenience of our professional car rental services, designed to get you on the road with ease.
              </p>
            </div>
